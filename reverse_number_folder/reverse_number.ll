; ModuleID = 'reverse_number.c'
source_filename = "reverse_number.c"
...
@.str.2 = private unnamed_addr constant [23 x i8] c"Reverse Number Is :%ld\00", align 1
...
13:                                               ; preds = %10
  ...
  %18 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %17, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64* %6) #4
  br label %19
...
31:                                               ; preds = %19
  ...
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0), i64 %32)
  br label %34
