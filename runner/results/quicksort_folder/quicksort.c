...
int main() {
    do_nothing();
  int data[] = {8, 7, 2, 1, 0, 9, 6,5,77,67,54,33,21,23,45,67,777,7,2,101,-1,3,4,5,6,7,22,34,56,8, 7, 2, 1, 0, 9, 6,5,77,67,54,33,21,23,45,67,777,7,2,101,-1,3,4,5,6,7,22,34,56,8};
