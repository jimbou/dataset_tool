; ModuleID = 'binary_search_inst.bc'
...
binarySearch1:                                    ; preds = %binarySearch7, %binarySearch
  call void @rapl_A()
  %10 = load i32, i32* %7, align 4
  %11 = load i32, i32* %8, align 4
  %12 = icmp sle i32 %10, %11
  br i1 %12, label %binarySearch2, label %binarySearch8
...
binarySearch2:                                    ; preds = %binarySearch1
  ...
  br i1 %25, label %binarySearch3, label %binarySearch4

binarySearch3:                                    ; preds = %binarySearch2
  call void @rapl_A()
  %26 = load i32, i32* %9, align 4
  store i32 %26, i32* %4, align 4
  br label %binarySearch9
...
binarySearch4:                                    ; preds = %binarySearch2
  ...
  br i1 %33, label %binarySearch5, label %binarySearch6
...
main1:                                            ; preds = %main3, %main
  ...
  br i1 %7, label %main2, label %main4
...
main4:                                            ; preds = %main1
  ...
  %25 = icmp eq i32 %24, -1
  br i1 %25, label %main5, label %main6
