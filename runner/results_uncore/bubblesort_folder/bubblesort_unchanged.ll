; ModuleID = 'bubblesort_unchanged.c'
source_filename = "bubblesort_unchanged.c"
...
8:                                                ; preds = %5
  ...
  %10 = add nsw i32 %9, 1
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.7, i64 0, i64 0), i32 %10)
...
37:                                               ; preds = %5
  ...
  call void @bubbleSort(i32* %38, i32 %39)
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.8, i64 0, i64 0))
  %41 = getelementptr inbounds [30 x i32], [30 x i32]* %2, i64 0, i64 0
  %42 = load i32, i32* %4, align 4
  call void @printArray(i32* %41, i32 %42)
  call void @rapl_D()
  ret i32 0
}
