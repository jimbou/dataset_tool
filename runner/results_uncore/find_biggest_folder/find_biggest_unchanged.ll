; ModuleID = 'find_biggest_unchanged.c'
source_filename = "find_biggest_unchanged.c"
...
8:                                                ; preds = %5
  ...
  %10 = add nsw i32 %9, 1
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.5, i64 0, i64 0), i32 %10)
...
59:                                               ; preds = %40
  ...
  %61 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.6, i64 0, i64 0), i32 %60)
  call void @rapl_D()
  ret i32 0
}
