...
partition1:                                       ; preds = %partition5, %partition
  call void @rapl_A()
  %17 = load i32, i32* %8, align 4
  %18 = load i32, i32* %5, align 4
  %19 = icmp slt i32 %17, %18
  br i1 %19, label %partition2, label %partition6
...
partition2:                                       ; preds = %partition1
  ...
  br i1 %26, label %partition3, label %partition4
...
quickSort:
  ...
  %9 = icmp slt i32 %7, %8
  br i1 %9, label %quickSort1, label %quickSort2
