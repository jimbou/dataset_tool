; ModuleID = 'function_pointer_unchanged.c'
source_filename = "function_pointer_unchanged.c"
...
@.str.6 = private unnamed_addr constant [12 x i8] c"Sum is: %d\0A\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @addTwoNumbers(i32 %0, i32 %1) #0 {
...
10:                                               ; preds = %7
  ...
  store i32 (i32, i32)* @addTwoNumbers, i32 (i32, i32)** %6, align 8
  %13 = load i32 (i32, i32)*, i32 (i32, i32)** %6, align 8
  %14 = load i32, i32* %3, align 4
  %15 = load i32, i32* %4, align 4
  %16 = call i32 %13(i32 %14, i32 %15)
  store i32 %16, i32* %5, align 4
  %17 = load i32, i32* %5, align 4
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.6, i64 0, i64 0), i32 %17)
  br label %19
