; ModuleID = 'polinominal_unchanged.c'
source_filename = "polinominal_unchanged.c"
...
@.str = private unnamed_addr constant [69 x i8] c"/sys/class/powercap/intel-rapl/intel-rapl:0/intel-rapl:0:1/energy_uj\00", align 1
...
@.str.5 = private unnamed_addr constant [42 x i8] c"Enter the degree of polynomial equation: \00", align 1
@.str.6 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.7 = private unnamed_addr constant [65 x i8] c"Ehter the value of x for which the equation is to be evaluated: \00", align 1
@.str.8 = private unnamed_addr constant [4 x i8] c"%LF\00", align 1
@.str.9 = private unnamed_addr constant [45 x i8] c"Enter the coefficient of x to the power %d: \00", align 1
@.str.10 = private unnamed_addr constant [66 x i8] c"The value of polynomial equation for the value of x = %LF is: %LF\00", align 1
@.str.11 = private unnamed_addr constant [14 x i8] c"rapl_rest.txt\00", align 1
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %7 = alloca [30 x x86_fp80], align 16
  ...
  call void @rapl_D()
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.5, i64 0, i64 0))
  %12 = load i8**, i8*** %5, align 8
  %13 = getelementptr inbounds i8*, i8** %12, i64 1
  %14 = load i8*, i8** %13, align 8
  %15 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %14, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), i32* %9) #5
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([65 x i8], [65 x i8]* @.str.7, i64 0, i64 0))
  %17 = load i8**, i8*** %5, align 8
  %18 = getelementptr inbounds i8*, i8** %17, i64 2
  %19 = load i8*, i8** %18, align 8
  %20 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %19, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i64 0, i64 0), x86_fp80* %6) #5
...
25:                                               ; preds = %21
  ...
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.9, i64 0, i64 0), i32 %26)
  ...
  %36 = getelementptr inbounds [30 x x86_fp80], [30 x x86_fp80]* %7, i64 0, i64 %35
  %37 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %33, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i64 0, i64 0), x86_fp80* %36) #5
  br label %38
...
41:                                               ; preds = %21
  %42 = getelementptr inbounds [30 x x86_fp80], [30 x x86_fp80]* %7, i64 0, i64 0
  %43 = load i32, i32* %9, align 4
  %44 = load x86_fp80, x86_fp80* %6, align 16
  %45 = call float @poly(x86_fp80* %42, i32 %43, x86_fp80 %44)
  ...
  %49 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str.10, i64 0, i64 0), x86_fp80 %47, x86_fp80 %48)
  call void @rapl_D()
  ret i32 0
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local float @poly(x86_fp80* %0, i32 %1, x86_fp80 %2) #0 {
  ...
  %12 = getelementptr inbounds x86_fp80, x86_fp80* %9, i64 %11
...
18:                                               ; preds = %15
  %19 = load x86_fp80*, x86_fp80** %4, align 8
  %20 = load i32, i32* %8, align 4
  %21 = sub nsw i32 %20, 1
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds x86_fp80, x86_fp80* %19, i64 %22
...
define dso_local void @rapl_A() #0 {
  ...
  %7 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([69 x i8], [69 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  store %struct._IO_FILE* %7, %struct._IO_FILE** %5, align 8
  %8 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.11, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  store %struct._IO_FILE* %8, %struct._IO_FILE** %6, align 8
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %5, align 8
  %10 = icmp eq %struct._IO_FILE* %9, null
  br i1 %10, label %11, label %12
