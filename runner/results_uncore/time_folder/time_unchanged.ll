; ModuleID = 'time_unchanged.c'
source_filename = "time_unchanged.c"
...
@.str.5 = private unnamed_addr constant [32 x i8] c"System Date is: %02d/%02d/%04d\0A\00", align 1
@.str.6 = private unnamed_addr constant [32 x i8] c"System Time is: %02d:%02d:%02d\0A\00", align 1
...
8:                                                ; preds = %5
  ...
  %10 = call %struct.tm* @localtime(i64* %3) #6
  %11 = bitcast %struct.tm* %4 to i8*
  %12 = bitcast %struct.tm* %10 to i8*
  ...
  %15 = getelementptr inbounds %struct.tm, %struct.tm* %4, i32 0, i32 4
  %16 = load i32, i32* %15, align 8
  %17 = add nsw i32 %16, 1
  %18 = getelementptr inbounds %struct.tm, %struct.tm* %4, i32 0, i32 5
  %19 = load i32, i32* %18, align 4
  %20 = add nsw i32 %19, 1900
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 %14, i32 %17, i32 %20)
  %22 = getelementptr inbounds %struct.tm, %struct.tm* %4, i32 0, i32 2
  %23 = load i32, i32* %22, align 8
  %24 = getelementptr inbounds %struct.tm, %struct.tm* %4, i32 0, i32 1
  %25 = load i32, i32* %24, align 4
  %26 = getelementptr inbounds %struct.tm, %struct.tm* %4, i32 0, i32 0
  %27 = load i32, i32* %26, align 8
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.6, i64 0, i64 0), i32 %23, i32 %25, i32 %27)
  br label %29
