; ModuleID = 'print_N_inst.bc'
source_filename = "print_N.c"
...
main:
  ...
  call void @rapl_B()
  %11 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %10, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), i32* %5) #5
  call void @rapl_C()
...
main1:                                            ; preds = %main3, %main
  ...
  br i1 %16, label %main2, label %main4
