; ModuleID = 'zombie_unchanged.c'
source_filename = "zombie_unchanged.c"
...
@.str.5 = private unnamed_addr constant [15 x i8] c"mu name is jef\00", align 1
@.str.6 = private unnamed_addr constant [30 x i8] c"Inside Parent---- PID is : %d\00", align 1
...
8:                                                ; preds = %5
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.5, i64 0, i64 0))
  %11 = call i32 @getpid() #5
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.6, i64 0, i64 0), i32 %11)
