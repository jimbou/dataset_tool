...
./divider  ../cleaner_folder/trace_clean.txt divider_code.txt divider_energy.txt ../run_folder/rapl_original.txt ../remover_folder/updated_rapl_rest.txt ../remover_folder/updated_rapl_last.txt sums.txt ../cost_folder/cost.txt  evaluation_real.txt>>divider_log.txt