...
percentages =[]
cur_dir = os.getcwd()
for subdir, dirs, files in os.walk(cur_dir+"/results_uncore"):
    for dir in dirs:
        print(dir)
...
plt.legend()
plt.savefig("plot_total_uncore.png")
...
plt.legend()
plt.savefig("plot_total_perc_uncore.png")
...
plt.legend()
plt.savefig("plot_total_average_uncore.png")
...
plt.legend()
plt.savefig("plot_total_average_perc_uncore.png")