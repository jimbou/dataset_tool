...
percentages =[]
cur_dir = os.getcwd()
for subdir, dirs, files in os.walk(cur_dir+"/results_ram"):
    for dir in dirs:
        print(dir)
...
plt.legend()
plt.savefig("plot_total_ram.png")
...
plt.legend()
plt.savefig("plot_total_perc_ram.png")
...
plt.legend()
plt.savefig("plot_total_average_ram.png")
...
plt.legend()
plt.savefig("plot_total_average_perc_ram.png")